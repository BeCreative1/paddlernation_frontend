...
const MenuItems = ({ showMenu, activeMenu, currentPage }) => {
  return (
    <ul
      className={
        activeMenu
          ? "flex-col flex items-center fixed top-0 sm:bottom-1/2 right-0 sm:left-1/4 md:left-1/2 uppercase backdrop-blur-md gap-8 justify-start p-8 z-auto"
          : "hidden"
      }
    >
      <AiOutlineClose
      ...
      <li
        className={
          "text-neutral-100" + (currentPage === "Udlejning" ? " font-bold" : "")
        }
      >
