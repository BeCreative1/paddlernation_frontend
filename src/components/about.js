                ...
                <div className="aboutText md:w-2/5 h-full flex items-center">
                  <div className="flex h-full flex-col justify-evenly">
                    ...
                    <span className="text-xs xl:text-sm 2xl:text-xl text-neutral-700 pt-4">
                      ...
                      paddleboard-udlejning og teambuilding-oplevelser i
                      Horsens. Vi tilbyder topkvalitets paddleboards til leje
                      til private og erhvervskunder, der ønsker at udforske de
                      smukke vandveje omkring Horsens.{" "}
                    </span>

                    <span className="text-xs xl:text-sm 2xl:text-xl text-neutral-700 pt-4">
                      Vi er også specialiseret i uforglemmelige
                      teambuilding-arrangementer, der vil hjælpe dit team med at
                      binde, udvikle færdigheder og have det sjovt i det fri.
                      Vores mission er at give dig den bedste oplevelse på
                      vandet med sikkerhed og komfort. Vi er stolte af at
                      tilbyde personlig service og uforglemmelige oplevelser på
                      vandet.{" "}
                    </span>

                    <span className="text-xs xl:text-sm 2xl:text-xl text-neutral-700 pt-4">
                      Vi er bekvemt placeret i Horsens, så du behøver ikke at
                      rejse langt for at starte dit eventyr. Tøv ikke med at
                      kontakte os for at skabe varige minder på vandet!
                    </span>
                  </div>
                </div>
              </div>
